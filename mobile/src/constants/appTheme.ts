...
/**
 * Bảng màu cho khu vực SAU đăng nhập (Trang chủ, Sản phẩm, Khảo sát...).
 * Dùng lại đúng bảng màu tối của màn Login/Register (AuthColors) để giao diện
 * đồng nhất; chỉ bổ sung vài màu trạng thái mà màn đăng nhập chưa cần.
 */
